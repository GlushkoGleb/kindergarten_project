        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="text-center">
                    <h2>Добавить посещаемость ребенка</h2>
                </div>
                <form method="post" action="teacher/add_attendance">
                    ...
                    <div class="mb-3">
                        <label for="data_attendance" class="form-label">Дата посещения</label>
                        <input type="date" name="data_attendance" class="form-control" placeholder="Введите дату посещения">
                    </div>
